...
o.bind("CTRL + ALT + DELETE", "Close all windows", "arcalos-hyprland-window-close-all")
...
o.bind("SUPER + O", "Pop window out (float & pin)", "arcalos-hyprland-window-pop")
o.bind("SUPER + L", "Toggle workspace layout", "arcalos-hyprland-workspace-layout-toggle")
...
o.bind("SUPER + code:61", "Cycle monitor scaling", "arcalos-hyprland-monitor-scaling-cycle")
o.bind("SUPER + ALT + code:61", "Cycle monitor scaling backwards", "arcalos-hyprland-monitor-scaling-cycle --reverse")
