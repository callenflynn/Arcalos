...
mkdir -p ~/.config/arcalos/themes

# Chromium policy directory for theme
sudo mkdir -p /etc/chromium/policies/managed
sudo chmod a+rw /etc/chromium/policies/managed

# Brave policy directory for theme
...
ln -snf ~/.config/arcalos/current/theme/btop.theme ~/.config/btop/themes/current.theme

mkdir -p ~/.config/mako
ln -snf ~/.config/arcalos/current/theme/mako.ini ~/.config/mako/config
