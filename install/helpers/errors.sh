# Directs user to Arcalos issues
QR_CODE='
...
catch_errors() {
  ...
  gum style --foreground 1 --padding "1 0 1 $PADDING_LEFT" "Arcalos installation stopped!"
  show_log_tail
  ...
  gum style "$QR_CODE"
  echo
  gum style "Open an issue at https://github.com/callenflynn/Arcalos/issues"
