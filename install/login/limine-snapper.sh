if command -v limine &>/dev/null; then
  sudo tee /etc/mkinitcpio.conf.d/ARCALOS_hooks.conf <<EOF >/dev/null
...
EOF
  ...
  sudo cp $ARCALOS_PATH/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $ARCALOS_PATH/default/limine/limine.conf /boot/limine.conf
  ...
  sudo cp $ARCALOS_PATH/default/snapper/root /etc/snapper/configs/root
