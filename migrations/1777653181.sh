...
if arcalos-hw-dell-xps-haptic-touchpad; then
  ...
  sudo rm -f /etc/arcalos-dell-haptic-touchpad.env
  sudo systemctl daemon-reload
  sudo udevadm control --reload-rules

  source "$ARCALOS_PATH/install/packaging/dell-xps-touchpad-haptics.sh"
fi
